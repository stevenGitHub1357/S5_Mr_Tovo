...
<body>
    ...
    <!-- <a href="<?php echo base_url('index.php/BackController/formBesoinInsert');?>" class="postuler-btn">Liste </a> -->
    <div class="annonces-container">
        ...
        <div class="annonce">
            ...
            <a href="BesoinDetail?idBesoin=<?php echo $Besoin[$i]['id']?>" class="postuler-btn" >Details</a>
        </div>
        <?php } ?>
    </div>
